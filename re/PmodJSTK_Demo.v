...
module formatting_JSTK(
	...
	// ===========================================================================
			...
			output [1:0] OUT;			// LEDs 2, 1, and 0
			output [1:0] OUT1;			// LEDs 2, 1, and 0
	...
	// ===========================================================================
			...
			wire [1:0] OUT;				// Status of PmodJSTK buttons displayed on LEDs
			wire [1:0] OUT1;				// Status of PmodJSTK buttons displayed on LEDs
	...
	// ===========================================================================
			...
			formatting_buttons button_format(
			   .clk(CLK),
			   .OUT(OUT1),
			   .Buttons(Buttons)
			   );
